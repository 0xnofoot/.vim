...
nnoremap <silent> m. :call signature#mark#Goto("prev", "spot", "pos")
nnoremap <silent> m, :call signature#mark#Goto("next", "spot", "pos")
...
map <Right> :vertical res -2
map <Left> :vertical res +2
map <Down> :res -2
map <Up> :res +2
...
badd +0 ~/.config/zsh/.gitignore
argglobal
%argdel
$argadd .gitignore
edit ~/.config/zsh/.gitignore
argglobal
let s:cpo_save=&cpo
set cpo&vim
